...
class TestDialogIntegration(unittest.TestCase):
    ...
    def test_add_connector_integration(self, mock_notebook, mock_photo, mock_tk):
        ...
        with patch('wireviz_gui.app.InputOutputFrame.grid'), \
    ...
    def test_dialog_outputs(self):
        ...
        with patch('wireviz_gui.dialogs.tk.Label'), \
             patch('wireviz_gui.dialogs.tk.Entry', side_effect=lambda *args, **kwargs: MagicMock()) as MockEntry, \
        ...
        cb.reset_mock()
        with patch('wireviz_gui.dialogs.tk.Label'), \
             patch('wireviz_gui.dialogs.tk.Entry', side_effect=lambda *args, **kwargs: MagicMock()), \
             patch('wireviz_gui.dialogs.tk.Button'), \
             patch('wireviz_gui.dialogs.tk.Frame'), \
             patch('wireviz_gui.dialogs.ttk.Combobox', side_effect=lambda *args, **kwargs: MagicMock()) as MockCombo, \
        ...
        with patch('wireviz_gui.dialogs.tk.Label'), \
             patch('wireviz_gui.dialogs.tk.Button'), \
             patch('wireviz_gui.dialogs.ttk.Combobox', side_effect=lambda *args, **kwargs: MagicMock()):
